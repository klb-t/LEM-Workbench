...
class ResearchAgent {
    ...
    suspend fun generateText(prompt: String, modelName: String = "gemini-3.5-flash", systemPrompt: String? = null): String? = withContext(Dispatchers.IO) {
    ...
    suspend fun getEmbedding(text: String, modelName: String = "gemini-embedding-2-preview", dimensions: Int? = null): List<Float>? = withContext(Dispatchers.IO) {
